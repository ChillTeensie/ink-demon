...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		levelInfo.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.fromInt(0xFFFFCC66));
		...
		levelDifficulty.setFormat(Paths.font('vcr.ttf'), 32, FlxColor.fromInt(0xFFFFCC66));
		...
		perSongOffset.setFormat("VCR OSD Mono", 16, FlxColor.fromInt(0xFFFFCC66), LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
