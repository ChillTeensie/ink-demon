...
class KeyBindMenu extends FlxSubState
{
	...
	{	
		...
		keyTextDisplay.setFormat("VCR OSD Mono", 42, FlxColor.fromInt(0xFFFFCC66), FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		infoText.setFormat("VCR OSD Mono", 24, FlxColor.fromInt(0xFFFFCC66), FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
