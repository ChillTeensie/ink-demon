...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
			...
			case 'ink1':
				{
						defaultCamZoom = 0.9;
						curStage = 'ink1';
						var bg:FlxSprite = new FlxSprite(-280, -175).loadGraphic(Paths.image('bg1', 'bendy'));
						bg.antialiasing = true;
		...
		if (FlxG.save.data.songPosition) // I dont wanna talk about this code :(
			{
				...
				{	
					songPosBar.createFilledBar(FlxColor.BLACK, FlxColor.fromInt(0xFFFFCC66));
				}
				add(songPosBar);
				...
				{
					songName.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.fromInt(0xFFFFCC66), RIGHT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
				}
		...
		{
			healthBar.createFilledBar(0xFF000000, 0xFFFFCC66);
		}
		// healthBar
		add(healthBar);
		...
		{
			kadeEngineWatermark.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.fromInt(0xFFFFCC66), RIGHT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
		}
		...
		{
			scoreTxt.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.fromInt(0xFFFFCC66), FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
		}
		...
		{
			replayTxt.setFormat(Paths.font("vcr.ttf"), 42, FlxColor.fromInt(0xFFFFCC66), RIGHT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
		}
		...
		{
			botPlayState.setFormat(Paths.font("vcr.ttf"), 42, FlxColor.fromInt(0xFFFFCC66), RIGHT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
		}
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			switch (noteTypeCheck)
			{
				...
				case 'inky1':
					babyArrow.frames = Paths.getSparrowAtlas('NOTE_assets', 'bendy');
	...
	private function popUpScore(daNote:Note):Void
		{
			...
			if (curStage.startsWith('ink1'))
			{
				pixelShitPart1 = 'bendyui/';
				pixelShitPart2 = '-ink';
			}
			...
			{
				case 'shit' | 'bad':
					currentTimingShown.color = FlxColor.BLACK;
				case 'good':
					currentTimingShown.color = FlxColor.fromInt(0xFFB18B3A);
				case 'sick':
					currentTimingShown.color = FlxColor.fromInt(0xFFFFCC66);
			}
